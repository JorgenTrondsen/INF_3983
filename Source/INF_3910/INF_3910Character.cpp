...
AINF_3910Character::AINF_3910Character()
{
	...
	// this is current change on map_generation, might have to comment in again.
...
void AINF_3910Character::SetupPlayerInputComponent(UInputComponent *PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent *EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AINF_3910Character::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AINF_3910Character::Look);
	}
	else
	{
